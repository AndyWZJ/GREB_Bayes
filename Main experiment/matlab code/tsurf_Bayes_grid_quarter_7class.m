...
breaks_data =xlsread('E:\GREB\Natural_breakpoint_atsurf_7class.xlsx');
...
t2 = clock;
time=etime(t2,t1); 
save('Natural_breakpoint_atsurf_7class','Correct_rate','pre_result_degree','result_probability_table','time')
%%
